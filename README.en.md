...
I'm a **Software Engineering student and backend-focused developer** passionate about turning real problems into digital solutions.

I like going beyond the code: understanding the **business, process, user and experience** behind a problem before thinking about the solution.
...
**My focus:** Backend · Automation · APIs · Integrations · Databases · Digital Products
...
const fer = {
  ...
  focus: ["Backend", "Automation", "Digital Products"],
  mindset: "Build > Consume",
  currentlyExploring: ["Java", "TypeScript", "Software Architecture"],
  goal: "Build scalable products that create real impact."
};
```
...
> Technologies here represent tools I use, study or actively explore — not a list of buzzwords added just for decoration.
...
Workflows that connect systems and eliminate repetitive tasks.
...
APIs, business logic and systems behind digital products.
...
Connecting APIs, databases, CRMs and communication systems.
...
Turning ideas and real problems into useful digital products.
...
| 🎯 [Counting My Goals](https://github.com/Fermunizs/counting-my-goals) | Goals · Web development |
...
| 🔷 [TypeScript Playground](https://github.com/Fermunizs/typescript-playground) | TypeScript · Types · Practice |
